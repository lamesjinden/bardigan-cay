(ns wiki.bc.views.card-list
  (:require [reagent.core :as r]
            [wiki.bc.card :as cards]
            [wiki.bc.view :as view]
            [wiki.bc.views.inner-html-card :refer [inner-html]]
            [wiki.bc.views.card-shell :refer [card-shell]]
            [wiki.bc.views.deadline-card :refer [deadline]]
            [wiki.bc.views.lazy-graph :refer [suspended-graph-card-component]]
            [wiki.bc.views.lazy-workspace-card :refer [suspended-workspace-component]]
            [wiki.bc.views.manual-copy-card :refer [manual-copy]]))
